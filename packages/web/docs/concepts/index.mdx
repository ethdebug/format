...
**[Learn more about types →](/docs/concepts/types)**
...
**[Learn more about pointers →](/docs/concepts/pointers)**
...
**[Learn more about programs →](/docs/concepts/programs)**
...
**[Learn more about the info schema →](/docs/concepts/info)**
