...
<CodeListing
  packageName="@ethdebug/pointers"
  sourcePath="src/evaluate.ts"
  extract={(sourceFile) => sourceFile.getFunction("evaluateArithmeticSum")}
/>
...
<CodeListing
  packageName="@ethdebug/pointers"
  sourcePath="src/evaluate.ts"
  extract={(sourceFile) => sourceFile.getFunction("evaluateArithmeticProduct")}
/>
...
<CodeListing
  ...
  sourcePath="src/evaluate.ts"
  extract={(sourceFile) =>
    sourceFile.getFunction("evaluateArithmeticDifference")
  }
/>
...
<CodeListing
  packageName="@ethdebug/pointers"
  sourcePath="src/evaluate.ts"
  extract={(sourceFile) => sourceFile.getFunction("evaluateArithmeticQuotient")}
/>
...
<CodeListing
  ...
  sourcePath="src/evaluate.ts"
  extract={(sourceFile) =>
    sourceFile.getFunction("evaluateArithmeticRemainder")
  }
/>
