...
implementation in the **@ethdebug/pointers** reference implementation
package.
...
**Remember** from the section on
[Cursors](/docs/implementation-guides/pointers/types/cursors) that a `Cursor`
