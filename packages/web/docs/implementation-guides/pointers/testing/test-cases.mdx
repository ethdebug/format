...
See the [Test code](/docs/implementation-guides/pointers/testing/summary#test-code)
heading on this section's summary page for how this variable is used by the
