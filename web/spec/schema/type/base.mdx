...
:::warning
This format extends the schema on this page by defining more specific
schemas for many common kinds of types (e.g. including signed/unsigned
...
appropriate more-specific schema. Please see the
[canonical Type schema](/spec/schema/type) for the full list.
:::
