...
This format defines this **ethdebug/format/type** schema for representing the
data types allowable in a supporting high-level language.
...
1. A canonical Type schema (**ethdebug/format/type**), which includes
...
2. A base Type schema (**ethdebug/format/type/base**), which specifies a
